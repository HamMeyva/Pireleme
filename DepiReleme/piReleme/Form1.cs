...
namespace piReleme
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text.Contains("B"))
            {
                textBox3.Text = textBox3.Text.Replace("B", "467");
            }
            ...
            if (textBox1.Text.Contains("K"))
            {
                textBox3.Text = textBox3.Text.Replace("K", "675");
            }
            ...
            {
                textBox3.Text = textBox3.Text.Replace("ü", "829");
            }
            ...
            if (textBox1.Text.Contains("Ü"))
            {
                textBox3.Text = textBox3.Text.Replace("Ü", "358");
            }
            ...
            using (BinaryReader reader = new BinaryReader(new FileStream(file, FileMode.Open)))
            {
                ...
                Random r = new Random();
                int rInt = r.Next(100000, 999999); //intler için
